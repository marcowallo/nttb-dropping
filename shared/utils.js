window.Utils = {
  ...
  normalizeEvent(data) {
    ...
    d.settings.participantIntroTitle = d.settings.participantIntroTitle || "Welkom bij de dropping";
    d.settings.participantIntroText = d.settings.participantIntroText || "Lees de uitleg goed door.";
    d.groups = d.groups || {};
    d.routes = d.routes || {};
